...
module Part3.TTIF where

import Part3.TTF as F hiding (main) -- The final embedding
...
i2f ::
  (Symantics repr, BoolSYM repr, MulSYM repr, FixSYM repr) =>
  IR repr t ->
  repr t
i2f (INT x) = int x
i2f (BOOL x) = bool x
...
tf2' :: (Symantics repr, BoolSYM repr, MulSYM repr, FixSYM repr) => repr (Int -> Int)
tf2' = i2f ti2
...
tfpow72' :: (Symantics repr, BoolSYM repr, MulSYM repr, FixSYM repr) => repr Int
tfpow72' = i2f tipow72
...
fif :: (Symantics repr, BoolSYM repr, MulSYM repr, FixSYM repr) => IR repr t -> repr t
fif fr = i2f . f2i $ fr
