...
tpow :: (Symantics repr, FixSYM repr, BoolSYM repr, MulSYM repr) => repr (Int -> Int -> Int)
tpow =
  lam
    ( \x ->
        fix
...
tpow7 :: (Symantics repr, FixSYM repr, BoolSYM repr, MulSYM repr) => repr (Int -> Int)
tpow7 = lam (\x -> app (app tpow x) (int 7))

tpow72 :: (Symantics repr, FixSYM repr, BoolSYM repr, MulSYM repr) => repr Int
