...
--  The initial style
module Part2.PushNegI where

import Part1.Intro1 hiding (main)
...
main :: IO ()
main = do
  print Part2.PushNegI.ti1_view
  print ti1_norm_view
  print ti1n_norm_view
  if ti1_norm_view == ti1nn_norm_view
    then return ()
    else error "Double neg"
  if eval ti1 == ti1_norm_eval
    then return ()
    else error "Normalization"
  if eval ti1 == - ti1n_norm_eval
    then return ()
    else error "Normalization"
